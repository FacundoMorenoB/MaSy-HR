...
<body>
    <div class="login-clean" style="background-color: rgb(255,255,255);">
        <form method="post" style="background-color: rgb(255,255,255);">
            ...
            <div class="form-group"><input type="text" class="form-control-disable" style="text-align: center;" disabled="true" value="<?php echo $this->session->flashdata('error');?>" ></div>
